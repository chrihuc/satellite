...
IO16 = {'62efV1.gox':(0b00111111,0b00000000,0b00000000,0b00000000,0b00000000,0b00000000,300,0b00000000,0b00000000), #(inputa,inputb,outputa,outputb,monoflopa,monoflopb,floptime[ms],normally open a, b)
        '63mHZj.vYN':(0b00000000,0b00000000,0b00000000,0b00001111,0b00000000,0b00000011,300,0b00000000,0b00000000)}
...
IO16o = {'V01ZIM1RUM1DO01':({'Value':0,'Commands':({'UID':'63mHZj.vYN','Pin':0b00000001,'Port':'B','Value':1},{'UID':'63mHZj.vYN','Pin':0b00000010,'Port':'B','Value':0})},
                            {'Value':1,'Commands':({'UID':'63mHZj.vYN','Pin':0b00000001,'Port':'B','Value':0},{'UID':'63mHZj.vYN','Pin':0b00000010,'Port':'B','Value':1})}),
